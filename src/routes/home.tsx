    ...
    <div className="flex-col w-full pb-24">
      <Container>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
          <p className="mx-auto -mt-4 max-w-2xl my-4 text-lg tracking-tight text-slate-700 sm:mt-6">
            Welcome to MockMentor! We're glad to have you here.
          </p>
          ...
          <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
            ...
            <span className="inline-block">to Interview Mastery</span>
          </h1>

          <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
            <span className="inline-block">
            Transform your interview anxiety into an opportunity.<br/>Practice, refine, and shine with MockMentor.
            </span> 
          </p>
          ...
          <div className="mt-12 flex flex-col justify-center gap-y-5 sm:mt-10 sm:flex-row sm:gap-y-0 sm:gap-x-6">
            ...
            >
              ...
              <span className="ml-3">Get Started Free</span>
            </a>
            <div
